...
const TrendingCoin = ({ data }) => {
  ...
  return (
    <div
      className="w-[40%] bg-gray-200 mb-12 last:mb-0 rounded-lg p-4 relative cursor-pointer transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-gray-100 hover:bg-opacity-40"
    ...
    >
      {data ? (
        <>
          ...
          <h3 className="txt-base flex items-center my-0.5">
            <span className="text-white capitalize">score:&nbsp;</span>
